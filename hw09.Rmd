...
* Our tasks are 
    ...
    iv. Report briefly on your past experience with git, and what you learned while studying for this homework. Edit the `hw09.Rmd` file in the `810f20` git repository, compile this to html (for example, using Rstudio) and submit your report via Canvas. 
